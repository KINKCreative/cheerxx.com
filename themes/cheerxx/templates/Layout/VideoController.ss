...
<div class="layout">
	<div class="row main">
		<div class="large-8 columns">
			...
			<small>For <% with Target %><strong><a href="$Link">$Title</a></strong><% end_with %> under <% with Target.SuperChallenge %><strong><a href="$Link">$Title</a></strong><% end_with %></small></p>
		...
		<div class="large-4 columns">
			...
			<h3>From the same challenge</h3>
			List of videos
			<h3>Staff picks</h3>
			List of videos
			<h3>More under Partner Stunt</h3>
			List of videos
