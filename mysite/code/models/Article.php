...
//		);
		...
		public function getCMSFields()
		{
			...
			$authorField = new ReadonlyField("AuthorHolder","Author","No authors found");
			$a = DataObject::get("Author","","Name ASC");
			if($a) {
				$authorField = new DropdownField("AuthorID","Select author",$a->toDropdownMap("ID","Name","Select"));
			}
